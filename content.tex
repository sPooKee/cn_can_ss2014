...
Auf der BUS Leitung werden die einzelnen Bits der Pakete über den 
...
gesendet werden. Abhilfe schafft hier Bit-Struffing, näheres dazu in Kapitel ~\ref{sec:bittiming}.
